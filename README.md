Open your browser and navigate to http://localhost:8000/index_webpage/index.html to begin triaging.
...
NOTE: Please, make sure to keep the Logs/Alerts panel webpage open if you want it to be active (generate the alerts) at all times.
NOTE: All of the alerts have been generated by AI.
